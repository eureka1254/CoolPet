...
export async function synthesizeVolcanoTts(apiKey: string, appId: string, voiceType: string, text: string): Promise<{
  success: boolean;
  http_status: number;
  content_type: string;
  ...
  return invoke("synthesize_volcano_tts", { apiKey, appId, voiceType, text });
}
